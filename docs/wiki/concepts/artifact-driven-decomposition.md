---
title: "artifact-driven-decomposition"
concept: "产物驱动的任务拆解"
...
## 核心要点
- **将过程描述转换为结构化交付标准**：给出的目标指令需精确挂靠到“产生什么文件”。（来源：[[AI_IDE_And_CLI] Run multiple agents at once...](/library/AI_IDE_And_CLI/AI_IDE_And_CLI%20-%20Run%20multiple%20agents%20at%20once%20with%20_fleet%20in%20Copilot%20CLI)）
...
## 关联概念
- [multi-agent-orchestrator](/wiki/concepts/multi-agent-orchestrator) — 此方式极度契合并并发机制，因为明确目标边界是触发 Orchestrator 安全下发子节点的大前提。

## 源文章引用
| 来源 | 关键段落摘录 |
|------|-------------|
| [[AI_IDE_And_CLI] Run multiple agents at once...](/library/AI_IDE_And_CLI/AI_IDE_And_CLI%20-%20Run%20multiple%20agents%20at%20once%20with%20_fleet%20in%20Copilot%20CLI) | "A good way to do that is being specific about deliverables. Map every work item to a concrete artifact like a file, a test suite, or a section of documentation... The second prompt gives the orchestrator four distinct deliverables, three of which can run in parallel, and one that depends on them." |
