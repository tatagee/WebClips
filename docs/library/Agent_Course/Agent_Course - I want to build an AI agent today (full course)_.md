---
title: "I want to build an AI agent today (full course):"
source: "https://x.com/hooeem/article/2037250422403113188"
category: "[Agent_Course]"
...
![Image](https://pbs.twimg.com/media/HEXC1sqbYAADQlB?format=jpg&name=large)
...
- **Tools:** functions the model can call (calculators, databases, APIs, file operations, etc.). Anthropic and OpenAI expose tools via JSON schemas; Anthropic passes an input\_schema while OpenAI wraps functions in a function object with parameters
...
![Image](https://pbs.twimg.com/media/HEXC7wXbYAA00mp?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HEXDMeiWMAAzcPj?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HEXDY09bYAMZ7mq?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HEXDg_0W4AQUP_p?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HEXDxwhbwAAQjd-?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HEXD4M7WsAAc6TR?format=jpg&name=large)
