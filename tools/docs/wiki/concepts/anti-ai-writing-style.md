...
## 核心要点
- **黑名单机制**：不要仅仅说“请自然地写作”，而是明确指出绝对不允许涉及的词汇，诸如：'delve', 'ensure', 'moreover', 'embrace' 等。（来源：[[AI_Prompt_Engineering] How to set up Claude Cowork (the April 2026 update)_.md](/library/AI_Prompt_Engineering/AI_Prompt_Engineering%20-%20How%20to%20set%20up%20Claude%20Cowork%20(the%20April%202026%20update)_)）
...
## 关联概念
- [context-optimization](/wiki/concepts/context-optimization) — 这是长期背景注入中的一部分优化点。
