...
- **Surgical Changes (外科手术式修改)**：极度克制代码改动，仅修改任务直接要求的部分，不动其他。（来源：[[[Claude_Code_Skills] Google engineer automated 80% of his work with Claude Code. here's the exact system he built..md]]）
...
## 关联概念
- [[claude-code-mastery]] — 属于掌控 CLI 工具的基础能力。
