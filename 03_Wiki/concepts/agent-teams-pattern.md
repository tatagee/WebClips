...
## 核心要点
- **跨周期的持久记忆**：各个团队成员 Agent 能在不同会话中积累处理任务的情境记忆（如总结历史漏洞和风格）。（来源：[[[Agent_Architecture] Multi-agent coordination patterns_ Five approaches and when to use them.md]]）
...
## 关联概念
- [[multi-agent-orchestrator]] — 作为应对不同复杂环境的镜像解决方案。
