...
## 核心要点
- **零条件强制验证**：管道包括语法检查、单测、端到端测试，且该流程必须是确定性的，即不能被手工绕过。（来源：[[[Agent_Architecture] Why Your “AI-First” Strategy Is Probably Wrong.md]]）
...
## 关联概念
- [[agent-harness-pattern]] — 将此种强制执行的确定性系统当做一种核心的支持平台。
